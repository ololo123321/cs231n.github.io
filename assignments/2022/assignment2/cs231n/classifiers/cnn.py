...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params["W2"] = np.random.normal(loc=0.0, scale=weight_scale, size=(num_filters * h_out * w_out, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        x, cache_conv_relu = conv_relu_forward(X, W1, b1, conv_param)
        x, cache_pool = max_pool_forward_fast(x, pool_param)
        x, cache_affine_relu = affine_relu_forward(x, W2, b2)
        scores, cache_affine = affine_forward(x, W3, b3)
        ...
        dout, grads["W1"], grads["b1"] = conv_relu_backward(dout, cache_conv_relu)
